...
export const STATIC_MODEL_BASELINE: Omit<ModelEntry, "lastSeen" | "createdAt" | "updatedAt">[] = [
  ...
  // Anthropic Claude models
  {
    ...
    tierMinimum: "high",
    costPer1kInput: 150,   // $15/M
    costPer1kOutput: 750,  // $75/M
    maxTokens: 32000,
  ...
  },
  {
    ...
    tierMinimum: "normal",
    costPer1kInput: 30,    // $3/M
    costPer1kOutput: 150,  // $15/M
    maxTokens: 16000,
    contextWindow: 200000,
    supportsTools: true,
    supportsVision: true,
  ...
  // Aliases with dot notation (as returned by Conway model list)
  {
    modelId: "claude-haiku-4.5",
    provider: "anthropic",
    displayName: "Claude Haiku 4.5",
...
export const DEFAULT_ROUTING_MATRIX: RoutingMatrix = {
  ...
  low_compute: {
    ...
    heartbeat_triage: { candidates: ["claude-haiku-4-5", "claude-haiku-4.5"], maxTokens: 1024, ceilingCents: 2 },
    safety_check: { candidates: ["claude-haiku-4-5", "claude-haiku-4.5"], maxTokens: 2048, ceilingCents: 5 },
    summarization: { candidates: ["claude-haiku-4-5", "claude-haiku-4.5"], maxTokens: 2048, ceilingCents: 5 },
    planning: { candidates: ["claude-haiku-4-5", "claude-haiku-4.5"], maxTokens: 2048, ceilingCents: 5 },
  },
  critical: {
    agent_turn: { candidates: ["claude-haiku-4-5", "claude-haiku-4.5"], maxTokens: 2048, ceilingCents: 3 },
    heartbeat_triage: { candidates: ["claude-haiku-4-5", "claude-haiku-4.5"], maxTokens: 512, ceilingCents: 1 },
    safety_check: { candidates: ["claude-haiku-4-5", "claude-haiku-4.5"], maxTokens: 1024, ceilingCents: 2 },
